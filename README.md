...
Install the [NuGet package](https://www.nuget.org/packages/SimpleMvcSitemap.Core/) on your MVC project.
...
Support for .NET Framework and ASP.NET MVC has been dropped by version 4 of original SimpleMvcSitemap. Use [version 3](https://github.com/uhaciogullari/SimpleMvcSitemap/tree/v3) if you need to support this scenario.
